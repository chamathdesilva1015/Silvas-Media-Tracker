document.addEventListener('DOMContentLoaded', () => {
    ...
    const infoData = {
        ...
        'Bias & Effects': `
            <div class="rating-accordion criteria-accordion">
                ${[
                    {title: 'Genre Preference (The "Favorites" Weight)', text: 'I have a strong admitted preference for grounded dramas, high-concept sci-fi, and psychological thrillers. These genres naturally feel more "important" or intellectually rewarding to me. While I try to judge every film on its own merits, a cerebral sci-fi will almost always have a lower barrier to entry for my engagement than a standard action flick. Understanding this helps you see why my "Average" for a drama might still rank higher than a "Good" for a genre I’m less connected to.'},
                    {title: 'The "Prestige" Bias (Themes & Depth)', text: 'I am inherently drawn to philosophical, psychological, and socially relevant themes. I tend to overvalue *what* a movie is saying, sometimes at the expense of *how* well it is being said. A film that attempts to tackle the human condition—even if flawed—will often resonate with me more than a flawlessly executed popcorn movie that lacks thematic weight. This section exists so you know my scores are weighted toward "substance" as I define it.'},
                    {title: 'Talent & Personnel Attachment', text: 'Recognition of a specific Director or Actor can create an automatic "benefit of the doubt" scenario. If I admire a filmmaker\'s past body of work, I am more likely to look for profound meaning in their failures, whereas I might be harsher on an unknown director for the same mistakes. I acknowledge that my past experience with "Elite" talent creates an uneven playing field in my evaluations.'},
                    {title: 'Expectation & The "Hype" Trap', text: 'My scores are heavily influenced by the "Delta" between my expectations and the reality of the viewing experience. A highly hyped film that is "only" an 8/10 can feel like a disappointment (and get a 7.5), while a hidden gem I expected to be awful might get a generous "inflation" bump. This section serves as a reminder that my scores are often a measurement of my personal surprise or letdown.'},
                    {title: 'Recency & The "Pink Cloud" Effect', text: 'Newer films benefit from high emotional clarity. The music is fresher, the visual beats are clearer, and the impact is immediate. Older films often suffer from "memory decay," where only the flaws or the broadest strokes remain. Without active re-reviews, my rankings will naturally drift toward what I’ve watched recently. This reminds you that a 10-year-old 8/10 was likely just as impactful as today\'s 9/10 at the time.'},
                    {title: 'Series & Legacy Momentum', text: 'Sequels rarely exist in a vacuum for me. I am susceptible to "Legacy Bias," where my love for a franchise (like LOTR or Star Wars) fills in the gaps for a weaker entry. Conversely, a sequel can be punished for not living up to a legendary predecessor. My evaluations often carry the weight of the entire series, making it difficult for an entry to truly stand on its own feet.'},
                    {title: 'Production Scale (Hard on the Rich)', text: 'I tend to be "Hard on the Rich." A $200M blockbuster that has a single technical flaw feels like a failure to me, whereas a $50k indie film with similar flaws feels like a triumph of passion. I am biased toward the "underdog story" of production, which can result in independent films receiving higher ratings for efficiency compared to the bloated perfection of major studio releases.'}
                ].map(item => `
                    <div class="rating-item">
                        <div class="rating-header-click">
                            <div class="rating-score-label">
