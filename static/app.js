document.addEventListener('DOMContentLoaded', () => {
    ...
    // Rating Scale accordion interaction (for movie rating scale section)
    const ratingScaleContainer = document.getElementById('movieRatingScaleContainer');
    if (ratingScaleContainer) {
        ratingScaleContainer.addEventListener('click', (e) => {
